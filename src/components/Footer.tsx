...
const Footer = () => (
  <div className="flex flex-col space-y-4 bg-lighterBlack px-8 pb-24 pt-8">
    <div className="flex flex-row items-center justify-between">
      <div className="flex flex-col space-y-8 text-white">
        <div className="font-family-secondary text-3xl">CONTATTACI</div>
        <div className="font-family-regular space-y-4 text-xl font-light">
