...
const OurEvents = () => (
  ...
  >
    ...
    <div className="flex flex-col items-center justify-center *:my-8">
      ...
      <Link
        href="/works"
        className="border-2 border-secondaryLight p-3 text-xs duration-200 hover:border-enabledLight md:text-base dark:border-secondaryDark hover:dark:border-enabledDark"
      >
        Our Portfolio
      </Link>
    </div>
