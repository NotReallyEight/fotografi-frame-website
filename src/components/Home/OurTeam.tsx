...
const OurTeam = () => (
  <div className="mx-auto flex min-h-dvh max-w-[80dvw] snap-center flex-col items-center justify-evenly md:flex-row md:justify-center">
    <div className="glassmorph glassmorph-padding flex max-h-[30%] flex-1 flex-col items-center justify-center md:max-h-dvh">
