...
const OurWorks = () => (
  <div className="glassmorph md:glassmorph-padding mx-auto mt-[10dvh] flex min-h-[75dvh] max-w-[90dvw] flex-col items-center justify-evenly p-4 md:mt-[20dvh] md:min-h-[50dvh] md:max-w-[75dvw]">
