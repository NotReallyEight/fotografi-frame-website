              ...
              <form className="flex flex-col my-8">
                <div className="flex flex-row w-full gap-4">
                  {FORM_TEXT_INPUTS.map(({ id, label }, index) => (
                    ...
                    >
                      ...
                      <label
                        htmlFor={id}
                        className="absolute top-0 peer-focus:-top-5 peer-focus:text-accent transition-all duration-(--transition-duration) cursor-text"
                      >
                        {label}
                      </label>
                    </div>
                ...
                <div className="mt-8 flex flex-col gap-4">
                  ...
                  <div className="mt-4 flex flex-col gap-3">
                    <button
                      type="submit"
                      className="w-fit border cursor-pointer border-white/20 px-4 py-2 text-sm font-family-secondary text-white transition-all duration-(--transition-duration) hover:border-accent hover:bg-accent/10 hover:text-accent"
                    >
                      Invia
                    </button>
